...
Formate o README:
    - Bilíngue (🇧🇷 / 🇺🇸)
    - Badges horizontais clicáveis (Shields.io) com link, title, alt e target="_blank".
    - Badges (Shields.io): javascript, nodeJS, binance <https://www.binance.com/pt-BR/markets/overview>, binance spot test network <https://testnet.binance.vision/>
    - Objetivo do projeto em PT/EN
    - Créditos (🇧🇷 e 🇺🇸) referenciando o Luiz Tools https://github.com/luiztools/ que traz o maior e melhor conteúdo para estudo e ensino do bot cripto hoje no Brasil e no mundo. 
